/**********************************************
 * Objetivo: Listar cidades do estado escolhido  
 * Data: 29/08
 * Autor: Samuel Matos
 * Versao: 1.0
 *********************************************/
...
//Retorna as cidades de um estado tendo como base a sigla 
const getListaCidades = function (siglaEstado) {
   let sigla = siglaEstado;
   //Cria um obejto do tipo array
   let listaCidades = [];
   let erro = true;

   //Tratamento para validar se o argumento foi encaminhadio a funcao 
   if (typeof(sigla) != 'undefined') 
   {
      //Tratamento para validacao de sigla vazia e com diferenca de caracteres
      if (sigla != '' && sigla.length == 2) 
      {
         //Percorre o array de cidades para validadar a sigla
         cidades.forEach (item => {
            //Localiza o estado dentro do array
               if (item.sigla.indexOf(sigla.toUpperCase()) == 0) 
               {
                  //Percorre o array da chave de cidades dentro do estado escolhido
                  item.cidades.forEach(item => {
...
// console.table(getListaCidades('RJ'));
// console.table(getListaCidades('SP'));
// console.table(getListaCidades('MS'));
// console.table(getListaCidades('MG'));
// console.table(getListaCidades('MT'));
// console.table(getListaCidades('RS'));
// console.table(getListaCidades('AM'));
// console.table(getListaCidades('ES'));
// console.table(getListaCidades('PI'));
// console.table(getListaCidades('TO'));
// console.table(getListaCidades('AC'));
// console.table(getListaCidades('AL'));
// console.table(getListaCidades('PE'));
// console.table(getListaCidades('AM'));
// console.table(getListaCidades('CE'));
// console.table(getListaCidades('DF'));
// console.table(getListaCidades('GO'));
// console.table(getListaCidades('MA'));
// console.table(getListaCidades('PA'));
// console.table(getListaCidades('PB'));
// console.table(getListaCidades('PR'));
// console.table(getListaCidades('RN'));
// console.table(getListaCidades('RO'));
// console.table(getListaCidades('RR'));
// console.table(getListaCidades('SC'));
// console.table(getListaCidades('SE'));
